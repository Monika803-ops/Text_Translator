...
function App(){
  ...
  headers: {
    'x-rapidapi-key': 'd6406c8a46msh6d897088af425eap1f845cjsn23ef9ad011b5',
  ...
  return(
    <div className="h-screen w-screen bg-slate-200 items-center justify-center">
      <div className="flex items-center justify-center flex-col gap-y-10 ">
        <h1 className="text-3xl text-zinc-700 font-bold">
          Text Translator
        </h1>
        <div className="flex items-center justify-center flex-col gap-y-5">
          <textarea name="input text" className="bg-white h-30 w-[500px] border border-slate-700 outline-none rounded-lg text-lg px-5 -y-2" onChange={(e) => setTextInput(e.target.value)}/>
          <textarea name="output area" className="bg-white h-30 w-[500px] border border-slate-700 outline-none rounded-lg text-lg px-5 -y-2" value={result} readOnly/>
        </div>
        <div>
